...
echo "<br/>2015-01-02 +1 day:". date('c', strtotime('2015-01-02 +1 day')), "</br>";
...
echo "<br/><br/>月份";
echo "<br/>ordinal space dayname space 'of'   first day单用无效";
...
echo "<br/>ordinal space unit";
echo "<br/>上个月 last month: " . date('c', strtotime('last month'));
echo "<br/>second month:". date('c', strtotime('second month')), "</br>";
echo "<br/>twelfth month:". date('c', strtotime('twelfth month')), "</br>";
